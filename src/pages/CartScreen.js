...
export default class CartScreen extends React.Component {
	...
	{
		try {
			let cartItemSes=await AsyncStorage.setItem('@cartSessionData', JSON.stringify(this.state.cartItems));
				...
				{!cartItemsIsLoading &&
					<View style={{backgroundColor: '#fff', borderTopWidth: 2, borderColor: '#f6f6f6', paddingVertical: 5}}>
						...
						<View style={{flexDirection: 'row', justifyContent: 'flex-end', height: 32, paddingRight: 20, alignItems: 'center'}}>
							<TouchableOpacity style={[styles.centerElement, {backgroundColor: '#42f44b', width: 100, height: 25, borderRadius: 5}]} onPress={() => this.goToCheckout()}>
